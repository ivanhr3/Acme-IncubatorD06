...
<acme:form>
	...
	<acme:form-textbox code="administrator.toolrecord.form.label.sector" path="sector.name"/>
	...
	<acme:form-url code="administrator.toolrecord.form.label.web" path="web"/>
	...
	<acme:form-submit test="${ command == 'create' }" code="administrator.toolrecord.form.button.submit" action="/administrator/tool-record/create"/>
