...
<acme:form readonly="true">
	...
	<acme:form-money code="authenticated.overture.form.label.minimumMoney" path="minimumMoney"/>
	<acme:form-money code="authenticated.overture.form.label.maximumMoney" path="maximumMoney"/>
