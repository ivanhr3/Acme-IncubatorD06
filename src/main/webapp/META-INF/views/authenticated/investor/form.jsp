...
<acme:form readonly="false">
	...
	<acme:form-submit code="authenticated.investor.form.button.submit" test="${command == 'create' }" action="/authenticated/investor/create"/>
	<acme:form-submit code="authenticated.investor.form.button.update" test="${command == 'update' }" action="/authenticated/investor/update"/>
